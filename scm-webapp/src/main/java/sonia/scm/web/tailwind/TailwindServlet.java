...
@Singleton
@WebElement(value = "/tailwind.bundle.css")
public class TailwindServlet extends HttpServlet {
  private static final Logger LOG = LoggerFactory.getLogger(TailwindServlet.class);
  ...
  @Inject
  public TailwindServlet(PluginLoader pluginLoader) {
